...
public class TextAreaDefaults {
    ...
    public static TextAreaDefaults getDefaults() {
        ...
        DEFAULTS.caretBlinks = (rars.Globals.getSettings().getCaretBlinkRate() != 0);
        DEFAULTS.caretBlinkRate = rars.Globals.getSettings().getCaretBlinkRate();
        DEFAULTS.tabSize = rars.Globals.getSettings().getEditorTabSize();
